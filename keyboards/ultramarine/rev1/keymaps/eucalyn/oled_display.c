...
static void render_layer_status(void) {
  // Define layers here, Have not worked out how to have text displayed for each layer. Copy down the number you see and add a case for it below
    ...
    int layer_state_mod = layer_state / 4;
    switch (layer_state) {
    case 0:
    case 1:
    ...
    // case 4: 
    // case 5:
    //     oled_write_P(PSTR("JIS Lower"), false);
    //     break;
    // case 6:
    //     oled_write_P(PSTR("US  Lower"), false);
    //     break;
    // case 8:
    // case 9:
    //     oled_write_P(PSTR("JIS Raise"), false);
    //     break;
    // case 10:
    //     oled_write_P(PSTR("US  Raise"), false);
    //     break;
    // case 28:
    // case 29:
    //     oled_write_P(PSTR("JIS Adjust"), false);
    //     break;
    // case 30:
    //     oled_write_P(PSTR("US  Adjust"), false);
    //     break;
    default:
        oled_write_P(PSTR("Layer "), false);
...
void render_status(void) {
  // Render to mode icon
    ...
    } else if (os_oled_mode == 1) {
        oled_write_P(os_logo[0][0], false);
        oled_write_P(PSTR("\n"), false);
        oled_write_P(os_logo[0][1], false);
    } else if (os_oled_mode == 2) {
